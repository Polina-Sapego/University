...
class testsRepository {
  ...
  async create(testsInf){
    return await tests.create(testsInf)
  }

  async update(id, testsData){
    return await tests.update (testsData,{where: {id}});
  }

  async delete(id){
    return await tests.destroy({where:{id}});
  }
  ...
  async findId(id){
    return await tests.findOne({where:{id}});
  }
