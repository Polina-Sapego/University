const speciality_test = require("../models/speciality_test");


class speciality_testRepository {


  async create(speciality_testInf){
    return await speciality_test.create(speciality_testInf)
  }

  async update(id, speciality_testData){
    return await speciality_test.update (speciality_testData,{where: {id}});
  }

  async delete(id){
    return await speciality_test.destroy({where:{id}});
  }
  ...
  async findId(id){
    return await speciality_test.findOne({where:{id}});
  }
...
module.exports = new speciality_testRepository();
