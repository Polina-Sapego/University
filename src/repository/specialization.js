...
class specialityRepository {
  ...
  async create(userInf){
    return await speciality.create(userInf)
  }

  async update(id, userData){
    return await speciality.update (userData,{where: {id}});
  }

  async delete(id){
    return await speciality.destroy({where:{id}});
  }
  ...
  async findId(id){
    return await speciality.findOne({where:{id}});
  }
